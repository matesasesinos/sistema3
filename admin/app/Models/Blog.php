...
class Blog extends Model
{
  ...
  public function getBlog()
  {
    ...
    ->select('blog_post.*', 'blog_categories.id_category', 'blog_categories.link_rewrite as category', 'blog_categories.name as category_name', 'users.name as author_name', 'users.lastname as author_lastname')
  ...
  {
    return Blog::find($id_post)->delete();
  }
}
