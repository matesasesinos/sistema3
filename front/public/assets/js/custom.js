...
//----------------------------------- Document ready -----------------------------------//
       ...
       $(document).ready(function() {	
			...
			if (!$.trim($(this).val())) { //if this field is empty 
			  ...
			  $("#contact_results").html('<br><div class="alert alert-danger">Por favor complete los campos obligatorios.</div>').show();
			...
			if ($(this).attr("type") === "email" && !email_reg.test($.trim($(this).val()))) {
				$(this).css('border-color', '#e44747'); 
				$("#contact_results").html('<br><div class="alert alert-danger">Por favor ingrese un correo válido.</div>').show();
				proceed = false; //set do not proceed flag				
			}
			});
